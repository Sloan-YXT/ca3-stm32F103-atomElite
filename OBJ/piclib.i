...
#line 2 "..\\PICTURE\\piclib.c"
#line 3 "..\\PICTURE\\piclib.c"
...
{	
	u8	res;
	u8 temp;	
	if((x+width)>picinfo.lcdwidth)return 0x29;		
	if((y+height)>picinfo.lcdheight)return 0x29;		
