...
const u8 *ATK_ESP8266_WORKMODE_TBL[3]={"TCP服务器","TCP客户端"," UDP 模式"};	

const u8 *ATK_ESP8266_ECN_TBL[5]={"OPEN","WEP","WPA_PSK","WPA2_PSK","WPA_WAP2_PSK"};

static u32 sendno;
extern int has_connect;
...
void atk_8266_send_data_neat_large(u8 link,u8 *data,u32 len,u8 *ack,u16 waittime)
{
	...
	while(rest>0)
	{
		...
		do
		{
			while(atk_8266_send_cmd(s,(u8 *)"OK",waittime));
