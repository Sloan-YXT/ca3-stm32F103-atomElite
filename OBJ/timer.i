...
void TIM3_Int_Init(u16 arr,u16 psc)
{
	...
	TIM_ITConfig(  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),((uint16_t)0x0001)  |  ((uint16_t)0x0040),  ENABLE  );
...
{	 
	...
	TIM5_ICInitStructure.TIM_Channel = ((uint16_t)0x0000); 
  	TIM5_ICInitStructure.TIM_ICPolarity = ((uint16_t)0x0000);	
  	TIM5_ICInitStructure.TIM_ICSelection = ((uint16_t)0x0001);
  	TIM5_ICInitStructure.TIM_ICPrescaler = ((uint16_t)0x0000);	 
  	TIM5_ICInitStructure.TIM_ICFilter = 0x00;

  	TIM_ICInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)), &TIM5_ICInitStructure);
...
{ 
	...
	if (TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)), ((uint16_t)0x0002)) != RESET)
		{	
			...
			{	  			
				TIM5CH1_CAPTURE_STA|=0X80;		
				TIM5CH1_CAPTURE_VAL=TIM_GetCapture1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)));
		   		TIM_OC1PolarityConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)),((uint16_t)0x0000)); 
			}else  								
			{
				TIM5CH1_CAPTURE_STA=0;			
				TIM5CH1_CAPTURE_VAL=0;
	 			TIM_SetCounter(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)),0);
				TIM5CH1_CAPTURE_STA|=0X40;		
		   		TIM_OC1PolarityConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)),((uint16_t)0x0002));		
			}		    
		}			     	    					   
 	}
 
    TIM_ClearITPendingBit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)), ((uint16_t)0x0002)|((uint16_t)0x0001)); 
...
void TIM6_Int_Init(u16 arr,u16 psc)
{
  TIM_TimeBaseInitTypeDef  TIM_TimeBaseStructure;
	...
	TIM_ITConfig( ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000)),((uint16_t)0x0001)|((uint16_t)0x0040),ENABLE);
