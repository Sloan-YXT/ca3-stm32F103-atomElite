...
#line 2 "..\\HARDWARE\\USART3\\usart3.c"
...
#line 4 "..\\HARDWARE\\USART3\\usart3.c"
...
#line 5 "..\\HARDWARE\\USART3\\usart3.c"
...
#line 6 "..\\HARDWARE\\USART3\\usart3.c"
...
#line 7 "..\\HARDWARE\\USART3\\usart3.c"
...
#line 8 "..\\HARDWARE\\USART3\\usart3.c"
...
u8 USART3_RX_BUF[6000+1]; 				
u8  USART3_TX_BUF[6000+1]; 			
...
void USART3_IRQHandler(void)
{
		...
		if((USART3_RX_STA&~(1<<15|1<<14))<6000)	
		{
				
			TIM_SetCounter(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400)),0);
...
{  
	...
	RCC_APB1PeriphClockCmd(((uint32_t)0x00040000),ENABLE); 
 	...
 	USART_DeInit(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)));  
...
void usart3_enable_flow_control(void)
{
	USART_TypeDef* usart3 = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800));
	usart3->CR3 |= ((uint16_t)0x0200);
}
...
void u3_printf_neat(u8 *data,u32 len)
{
	...
	for(j=0;j<i;j++)							
	{
	  while(USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)),((uint16_t)0x0040))==RESET); 
		...
		USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)),USART3_TX_BUF[j]); 
	} 
}
void u3_printf(char* fmt,...)  
{  
