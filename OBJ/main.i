...
extern u8  USART3_RX_BUF[6000+1]; 		
extern u8  USART3_TX_BUF[6000+1]; 		
...
#line 12 "main.c"
#line 1 "..\\ATK-ESP8266\\common.h"
#line 4 "..\\ATK-ESP8266\\common.h"
#line 5 "..\\ATK-ESP8266\\common.h"
#line 6 "..\\ATK-ESP8266\\common.h"
#line 7 "..\\ATK-ESP8266\\common.h"
#line 8 "..\\ATK-ESP8266\\common.h"
#line 9 "..\\ATK-ESP8266\\common.h"
#line 10 "..\\ATK-ESP8266\\common.h"
...
#line 11 "..\\ATK-ESP8266\\common.h"
#line 12 "..\\ATK-ESP8266\\common.h"
#line 13 "..\\ATK-ESP8266\\common.h"
#line 14 "..\\ATK-ESP8266\\common.h"
...
u8 atk_8266_send_data_neat(u8 *data,u32 len,u8 *ack,u16 waittime);	
void atk_8266_send_data_neat_large(u8 link,u8 *data,u32 len,u8 *ack,u16 waittime);
...
#line 19 "main.c"
#line 1 "..\\HARDWARE\\OV7725\\ov7725.h"
#line 4 "..\\HARDWARE\\OV7725\\ov7725.h"
#line 1 "..\\HARDWARE\\OV7725\\sccb.h"
#line 4 "..\\HARDWARE\\OV7725\\sccb.h"
...
#line 5 "..\\HARDWARE\\OV7725\\ov7725.h"
...
#line 25 "..\\HARDWARE\\OV7725\\ov7725.h"
...
u8 get_smoke(void);
#line 24 "main.c"
#line 1 "..\\HARDWARE\\DHT11\\dht11.h"
#line 4 "..\\HARDWARE\\DHT11\\dht11.h"
...
void photo_generate(u8 link,u8 *pname)
{
	u8 res;
	int32_t i,j;
 	u16 color;	 
	...
	u16 databuf[320];
	u16 bi4width = 320*2;
	u16 bmpheadsize=sizeof(BITMAPINFO);
	...
	if(ov_sta)
	{
		res = bmp_encode_in(link,f_bmp,pname,320,240,0);
		if(res)
		{
			printf("Ð´ÈëÎÄ¼þ´íÎó\r\n");		 
			return;
		...
		*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+12) &0xFFFFF)<<5)+(14<<2))))=0;				
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR=1<<4;
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR=1<<4;
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR=1<<4;
		*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+12) &0xFFFFF)<<5)+(14<<2))))=1;				
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR=1<<4; 
		for(j=0;j<240;j++)
		{
			...
			{
			((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR=1<<4;
			color=((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->IDR&0XFF;	
			((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR=1<<4; 
			color<<=8;  
			((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR=1<<4;
			color|=((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->IDR&0XFF;	
			...
			atk_8266_send_data_neat_large(link,(u8*)databuf,bi4width,(u8 *)"OK",300);
		}   		
		if(res)
		{
			printf("write graph to sd card fail!\r\n");
		}
		f_close(f_bmp);   
...
void generator(u8 *data,u32 len)
{
	u32 i = 0;
	while(i < len)
	{
...
u32 htonl(u32 data)
{
 ...
 int main(void)
 {
	...
	u8 *type = "stm32";
	u8 *position = "dandelion hotel 206";
	u8 *tick = "stm32f103 still in connection......";
	u8 temp[18],humi[18],light[2],smoke[2];
	u8 message_box[100];
	u16 temp_in,humi_in;
	u8 light_in,smoke_in;
	u32 len,rlen;
	SIZE = 	sizeof(BITMAPINFO)+320*240*2;	 
	delay_init();	    	 
  NVIC_PriorityGroupConfig(((uint32_t)0x500));
	...
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+12) &0xFFFFF)<<5)+(15<<2))))=0;					 
	TIM6_Int_Init(10000-1,7200-1);			
	EXTI8_Init();						
	atk_8266_send_cmd("AT+RESTORE","OK",50);
	delay(5);
	
	
	
	
	while(atk_8266_send_cmd("ATE0","OK",500));
	while(atk_8266_send_cmd("AT+CWMODE=1","OK",500)); 
	while(atk_8266_send_cmd("AT+CIPMUX=1","OK",500)); 
	while(atk_8266_send_cmd("AT+CWJAP=\"CMCC-206\",\"abc88889999abc\"","WIFI GOT IP",2000));
	delay(5);
	
	
	while(atk_8266_send_cmd("AT+CIPSTART=0,\"TCP\",\"192.168.1.85\",6666","CONNECT",2000));
	
	has_connect = 1;
	atk_8266_send_cmd("AT+CIPSEND=0,4","OK",5000);
	len = strlen(name);
	rlen = htonl(len);
	atk_8266_send_data_neat((u8*)&rlen,4,"OK",5000);
	atk_8266_send_data_neat_large(0,name,len,"OK",50);
	len = strlen(type);
	rlen = htonl(len);
	atk_8266_send_cmd("AT+CIPSEND=0,4","OK",500);
	atk_8266_send_data_neat((u8*)&rlen,4,"OK",500);
	atk_8266_send_data_neat_large(0,type,len,"OK",500);
	while(atk_8266_send_cmd("AT+CIPSTART=1,\"TCP\",\"192.168.1.85\",6667","CONNECT",500));
	while(atk_8266_send_cmd("AT+CIPSTART=2,\"TCP\",\"192.168.1.85\",6668","CONNECT",500));
	len = strlen(position);
	rlen = htonl(len);
	atk_8266_send_cmd("AT+CIPSEND=0,4","OK",5000);
	atk_8266_send_data_neat((u8*)&rlen,4,"OK",5000);
	atk_8266_send_data_neat_large(0,position,len,"OK",5000);
	while(1)
	{
		printf("%d\r\n",194);
		...
		light_in = get_light();
		smoke_in = get_smoke();
		sprintf(temp,"%d.%d",((temp_in&0xff00)>>8),(temp_in&0xff));
		sprintf(humi,"%d.%d",((humi_in&0xff00)>>8),(humi_in&0xff));
		...
		atk_8266_send_data_neat((u8 *)&rlen,4,"OK",5000);
		delay_ms(20);
		atk_8266_send_cmd("AT+CIPSEND=0,17","OK",5000);
		atk_8266_send_data_neat(temp,17,"OK",5000);
		delay_ms(20);
		atk_8266_send_cmd("AT+CIPSEND=0,17","OK",5000);
		atk_8266_send_data_neat(humi,17,"OK",5000);
		delay_ms(20);
		atk_8266_send_cmd("AT+CIPSEND=0,1","OK",5000);
		atk_8266_send_data_neat(light,1,"OK",5000);
		delay_ms(20);
		atk_8266_send_cmd("AT+CIPSEND=0,1","OK",5000);
		atk_8266_send_data_neat(smoke,1,"OK",5000);
		delay_ms(20);
		len = SIZE;
		rlen = htonl(len);
		atk_8266_send_cmd("AT+CIPSEND=1,4","OK",5000);
		atk_8266_send_data_neat((u8 *)&rlen,4,"OK",5000);
		photo_generate(1,"0:PHOTO/photo.bmp");
		delay(5);
		len = strlen(tick);
		sprintf(message_box,"AT+CIPSEND=2,%d",len);
		atk_8266_send_cmd(message_box,"OK",5000);
		atk_8266_send_data_neat(tick,len,"OK",5000);
		printf("next turn\r\n");
