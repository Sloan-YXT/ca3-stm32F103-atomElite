...
#line 5 "..\\HARDWARE\\SDIO\\sdio_sdcard.c"
...
SD_Error SD_Init(void)
{
  ...
  GPIO_InitTypeDef  GPIO_InitStructure;
	...
	RCC_AHBPeriphClockCmd(((uint32_t)0x00000400)|((uint32_t)0x00000002),ENABLE);
  ...
  if((errorstatus==SD_OK)||(((u32)0x00000003)==CardType))
	{  		    
		...
		errorstatus=SD_SetDeviceMode(0);	
 	}
	return errorstatus;		 
}
...
void SDIO_Clock_Set(u8 clkdiv)
{
	u32 tmpreg=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->CLKCR; 
  tmpreg&=0XFFFFFF00; 
 	tmpreg|=clkdiv;   
...
SD_Error SD_PowerON(void)
{
  ...
  SDIO_Init(&SDIO_InitStructure);
    ...
    SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)0); 
  ...
  SDIO_SendCommand(&SDIO_CmdInitStructure);
    ...
    SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)55);
    SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);
    SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
    SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
    SDIO_SendCommand(&SDIO_CmdInitStructure);		
	...
	{																  
      ...
      SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)41);
      SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);  
      SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
      SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
      SDIO_SendCommand(&SDIO_CmdInitStructure);
			...
			errorstatus=CmdResp3Error(); 					
 			...
 			if(errorstatus!=SD_OK)return errorstatus;   	
			response=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP1;;			   				
 	...
 	}else
	{
		...
		while((!validvoltage)&&(count<((u32)0x0000FFFF)))
		{	   										   				   
			SDIO_CmdInitStructure.SDIO_Argument = ((u32)0x80FF8000);
      SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)1);
      SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);  
      SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
      SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
      SDIO_SendCommand(&SDIO_CmdInitStructure);
...
SD_Error SD_InitializeCards(void)
{
	...
	{
		SDIO_CmdInitStructure.SDIO_Argument = 0x0;
    SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)2);
    ...
    SDIO_SendCommand(&SDIO_CmdInitStructure);
		...
		if(errorstatus!=SD_OK)return errorstatus;   	
 		CID_Tab[0]=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP1;
		CID_Tab[1]=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP2;
		CID_Tab[2]=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP3;
		CID_Tab[3]=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP4;
	}
	if((((u32)0x00000000)==CardType)||(((u32)0x00000001)==CardType)||(((u32)0x00000006)==CardType)||(((u32)0x00000002)==CardType))
	{
		SDIO_CmdInitStructure.SDIO_Argument = 0x00;
    SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)3);	
    SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040); 
    SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
    SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
    SDIO_SendCommand(&SDIO_CmdInitStructure);	
    ...
    SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)9);
    SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x000000C0);
    SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
    SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
    SDIO_SendCommand(&SDIO_CmdInitStructure);
		...
		errorstatus=CmdResp2Error(); 					
		if(errorstatus!=SD_OK)return errorstatus;   	
  		CSD_Tab[0]=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP1;
		CSD_Tab[1]=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP2;
		CSD_Tab[2]=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP3;						
		CSD_Tab[3]=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP4;					    
	}
	return SD_OK;
} 
...
SD_Error SD_EnableWideBusOperation(u32 wmode)
{
 	...
 	else if((((u32)0x00000000)==CardType)||(((u32)0x00000001)==CardType)||(((u32)0x00000002)==CardType))
	{
 		...
 		else   
		{
			...
			{
				((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->CLKCR&=~(3<<11);		
				((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->CLKCR|=(u16)wmode<<11;
				((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->CLKCR|=0<<14;			
			}
		}  
	}
	return errorstatus; 
...
SD_Error SD_SelectDeselect(u32 addr)
{
  ...
  SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)7);
  SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);
  SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
  SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
  SDIO_SendCommand(&SDIO_CmdInitStructure);
...
{	  
	...
	if(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP1&((u32)0x02000000))return SD_LOCK_UNLOCK_FAILED;
    ...
    SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)16);
    SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);
    SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
    SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
    SDIO_SendCommand(&SDIO_CmdInitStructure);
    ...
    SDIO_DataConfig(&SDIO_DataInitStructure);
	  ...
	  SDIO_CmdInitStructure.SDIO_Argument =  addr;
    SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)17);
    SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);
    SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
    SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
    SDIO_SendCommand(&SDIO_CmdInitStructure);
	...
	{
 		INTX_DISABLE();
		while(!(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->STA&((1<<5)|(1<<1)|(1<<3)|(1<<10)|(1<<9))))
		{
			if(SDIO_GetFlagStatus(((uint32_t)0x00008000)) != RESET)							
			{
				for(count=0;count<8;count++)			
				{
					*(tempbuff+count)=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->FIFO;
				}
				tempbuff+=8;	 
				timeout=0X7FFFFF; 	
			}else 	
	...
	{
  	SD_DMA_Config((u32*)buf,blksize,((uint32_t)0x00000000)); 
		TransferError=SD_OK;
		StopCondition=0;			
		TransferEnd=0;				
		((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->MASK|=(1<<1)|(1<<3)|(1<<8)|(1<<5)|(1<<9);	
		SDIO_DMACmd(ENABLE);
 		while(((((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0400))->ISR&0X2000)==RESET)&&(TransferEnd==0)&&(TransferError==SD_OK)&&timeout)timeout--;
		if(timeout==0)return SD_DATA_TIMEOUT;
...
SD_Error SD_ReadMultiBlocks(u8 *buf,long long addr,u16 blksize,u32 nblks)
{
	...
	{									    
       ...
       SDIO_CmdInitStructure.SDIO_Argument =  addr;
	     SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)18);
		   SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);
		   SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
		   SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
		   SDIO_SendCommand(&SDIO_CmdInitStructure);	
		...
		{
			INTX_DISABLE();
			while(!(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->STA&((1<<5)|(1<<1)|(1<<3)|(1<<8)|(1<<9))))
			{
			if(SDIO_GetFlagStatus(((uint32_t)0x00008000)) != RESET)					
				{
					for(count=0;count<8;count++)			
			...
			*tempbuff=SDIO_ReadData();	
	 		...
	 		if(SDIO_GetFlagStatus(((uint32_t)0x00000100)) != RESET)		
			{
				if((((u32)0x00000000)==CardType)||(((u32)0x00000001)==CardType)||(((u32)0x00000002)==CardType))
				{
				  ...
				  SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)12);
					SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);
					SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
					SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
					SDIO_SendCommand(&SDIO_CmdInitStructure);	
		...
		{
	 	    SD_DMA_Config((u32*)buf,nblks*blksize,((uint32_t)0x00000000)); 
	   		TransferError=SD_OK;
			StopCondition=1;			
			TransferEnd=0;				
			((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->MASK|=(1<<1)|(1<<3)|(1<<8)|(1<<5)|(1<<9);	
		 	((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->DCTRL|=1<<3;		 						
	 		while(((((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0400))->ISR&0X2000)==RESET)&&timeout)timeout--;
			if(timeout==0)return SD_DATA_TIMEOUT;
...
SD_Error SD_WriteBlock(u8 *buf,long long addr,  u16 blksize)
{
  ...
  SDIO_DataConfig(&SDIO_DataInitStructure);
	...
	if((blksize>0)&&(blksize<=2048)&&((blksize&(blksize-1))==0))
	{
		...
		SDIO_CmdInitStructure.SDIO_Argument = (u32)RCA<<16;
		SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)13);
		SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);
		SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
		SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
		SDIO_SendCommand(&SDIO_CmdInitStructure);	
	...
	if(errorstatus!=SD_OK)return errorstatus;
	cardstatus=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP1;													  
	...
	if(timeout==0)return SD_ERROR;
		...
		SDIO_CmdInitStructure.SDIO_Argument = addr;
		SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)24);
		SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);
		SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
		SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
		SDIO_SendCommand(&SDIO_CmdInitStructure);	
  ...
  SDIO_DataConfig(&SDIO_DataInitStructure);
	...
	{
		INTX_DISABLE();
		while(!(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->STA&((1<<10)|(1<<4)|(1<<1)|(1<<3)|(1<<9))))
		{
		...
		INTX_ENABLE();
		((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->ICR=0X5FF;	 		
	}else if(DeviceMode==1)
	{
		SD_DMA_Config((u32*)buf,blksize,((uint32_t)0x00000010));
   		TransferError=SD_OK;
		StopCondition=0;			
		TransferEnd=0;				
		((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->MASK|=(1<<1)|(1<<3)|(1<<8)|(1<<4)|(1<<9);	
 	 	((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->DCTRL|=1<<3;								
 		while(((((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0400))->ISR&0X2000)==RESET)&&timeout)timeout--;
		if(timeout==0)
		{
	...
	{					  
     	...
     	if((((u32)0x00000000)==CardType)||(((u32)0x00000001)==CardType)||(((u32)0x00000002)==CardType))
    	{
			...
			if(errorstatus!=SD_OK)return errorstatus;				 
				...
				SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)23);
				SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);
				SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
				SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
				SDIO_SendCommand(&SDIO_CmdInitStructure);
			...
			if(errorstatus!=SD_OK)return errorstatus;		
				...
				SDIO_CmdInitStructure.SDIO_Argument =addr;	
				SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)25);
				SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);
				SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
				SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
				SDIO_SendCommand(&SDIO_CmdInitStructure);	
		...
		if(DeviceMode==0)
	    {
			timeout=((u32)0xFFFFFFFF);
			INTX_DISABLE();
			while(!(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->STA&((1<<4)|(1<<1)|(1<<8)|(1<<3)|(1<<9))))
			{
				if(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->STA&(1<<14))							
				{	  
					if((tlen-bytestransferred)<((u32)0x00000020))
					{
						restwords=((tlen-bytestransferred)%4==0)?((tlen-bytestransferred)/4):((tlen-bytestransferred)/4+1);
		...
		{
			SD_DMA_Config((u32*)buf,nblks*blksize,((uint32_t)0x00000010));
	   		TransferError=SD_OK;
			StopCondition=1;			
			TransferEnd=0;				
			((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->MASK|=(1<<1)|(1<<3)|(1<<8)|(1<<4)|(1<<9);	
...
SD_Error SD_ProcessIRQSrc(void)
{
	if(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->STA&(1<<8))
	{	 
		if (StopCondition==1)
		{
			SDIO_CmdInitStructure.SDIO_Argument =0;
 		...
 		((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->ICR|=1<<8;
		((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->MASK&=~((1<<1)|(1<<3)|(1<<8)|(1<<14)|(1<<15)|(1<<4)|(1<<5)|(1<<9));
 		TransferEnd = 1;
		return(TransferError);
	}
 	if(SDIO_GetFlagStatus(((uint32_t)0x00000002)) != RESET)
	{
		SDIO_ClearFlag(((uint32_t)0x00000002));  		
		((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->MASK&=~((1<<1)|(1<<3)|(1<<8)|(1<<14)|(1<<15)|(1<<4)|(1<<5)|(1<<9));
 	...
 	if(SDIO_GetFlagStatus(((uint32_t)0x00000008)) != RESET)
	{
  	...
  	if(SDIO_GetFlagStatus(((uint32_t)0x00000020)) != RESET)
	{
		SDIO_ClearFlag(((uint32_t)0x00000020));  			
		((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->MASK&=~((1<<1)|(1<<3)|(1<<8)|(1<<14)|(1<<15)|(1<<4)|(1<<5)|(1<<9));
   	...
   	if(SDIO_GetFlagStatus(((uint32_t)0x00000010)) != RESET)
	{
		SDIO_ClearFlag(((uint32_t)0x00000010));  			
		((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->MASK&=~((1<<1)|(1<<3)|(1<<8)|(1<<14)|(1<<15)|(1<<4)|(1<<5)|(1<<9));
	...
	if(SDIO_GetFlagStatus(((uint32_t)0x00000200)) != RESET)
	{
		SDIO_ClearFlag(((uint32_t)0x00000200));  		
		((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->MASK&=~((1<<1)|(1<<3)|(1<<8)|(1<<14)|(1<<15)|(1<<4)|(1<<5)|(1<<9));
...
SD_Error CmdError(void)
{
	...
	while(timeout--)
	{
	  if(SDIO_GetFlagStatus(((uint32_t)0x00000080)) != RESET)break;	
	}	    
...
{	  
	...
	if(SDIO_GetFlagStatus(((uint32_t)0x00000004)) != RESET)					
	{																				    
 		SDIO_ClearFlag(((uint32_t)0x00000004)); 				
		return SD_CMD_RSP_TIMEOUT;
	}	
 	if(SDIO_GetFlagStatus(((uint32_t)0x00000001)) != RESET)					
	{																				    
 		SDIO_ClearFlag(((uint32_t)0x00000001)); 				
		return SD_CMD_CRC_FAIL;
	}		
	if(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESPCMD!=cmd)return SD_ILLEGAL_CMD;
  	((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->ICR=0X5FF;	 				
	return (SD_Error)(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP1&((u32)0xFDFFE008));
}
...
SD_Error CmdResp6Error(u8 cmd,u16*prca)
{
	...
	if(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESPCMD!=cmd)				
	{
 		return SD_ILLEGAL_CMD; 		
	}	    
	SDIO_ClearFlag(((u32)0x000005FF));
	
	rspr1=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP1;					
...
SD_Error SDEnWideBus(u8 enx)
{
   ...
   SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)6);
   SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);
   SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
   SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
   SDIO_SendCommand(&SDIO_CmdInitStructure);
...
SD_Error IsCardProgramming(u8 *pstatus)
{
  ...
  status=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->STA;
	...
	while(!(status&((1<<0)|(1<<6)|(1<<2))))status=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->STA;
   ...
   if(SDIO_GetFlagStatus(((uint32_t)0x00000004)) != RESET)			
	{
 	...
 	if(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESPCMD!=((u8)13))return SD_ILLEGAL_CMD;
	
	SDIO_ClearFlag(((u32)0x000005FF));
	
	respR1=((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->RESP1;
...
{ 
  ...
  SDIO_CmdInitStructure.SDIO_Argument = 0x0;
  SDIO_CmdInitStructure.SDIO_CmdIndex = ((u8)51);	
  SDIO_CmdInitStructure.SDIO_Response = ((uint32_t)0x00000040);  
  SDIO_CmdInitStructure.SDIO_Wait = ((uint32_t)0x00000000);
  SDIO_CmdInitStructure.SDIO_CPSM = ((uint32_t)0x00000400);
  SDIO_SendCommand(&SDIO_CmdInitStructure);
...
{		 
  ...
  DMA_DeInit(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0444)));   
	DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0444)), DISABLE ); 

	DMA_InitStructure.DMA_PeripheralBaseAddr = (u32)&((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->FIFO;  
