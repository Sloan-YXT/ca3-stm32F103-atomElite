...
void DHT11_Rst(void)	   
{                 
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2000))->CRH&=0XFFFF0FFF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2000))->CRH|=3<<12;}; 	
    *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+12) &0xFFFFF)<<5)+(11<<2))))=0; 	
    delay_ms(20);    	
    *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+12) &0xFFFFF)<<5)+(11<<2))))=1; 	
	delay_us(30);     	
}
...
{   
	u8 retry=0;
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2000))->CRH&=0XFFFF0FFF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2000))->CRH|=8<<12;};
    while (*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+8) &0xFFFFF)<<5)+(11<<2))))&&retry<100)
	{
		retry++;
		delay_us(1);
	};	 
...
u8 DHT11_Read_Bit(void) 			 
{
	...
	delay_us(40);
	if(*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x2000)+8) &0xFFFFF)<<5)+(11<<2)))))return 1;
	else return 0;		   
}
